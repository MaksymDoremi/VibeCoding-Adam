# Kompilace veškeré zpětné vazby – AI Vibe Coding Kurz

Tento soubor obsahuje veškerou zpětnou vazbu, kterou Adam Krummacker poskytl ke všem 10 lekcím kurzu AI Vibe Coding. Obsahuje detailní reflexe, poznámky, hodnocení a doporučení z obou hlavních feedback souborů.

---

## [feedback.md] – Kompletní reflexe a poznámky
...
**📝 Poznámky**
- 13leté děti by měly velké problémy s tímhle setupem bez lektora – je to dost komplexní
- Bylo by super, kdyby existoval předpřipravený VM/image s vším už nainstalovaným
- S lektorem to ale šlo bez větších problémů
- Čas jsem si nestopoval – časový pocit vychází z mého subjektivního dojmu, lektoři toto prosím berou na lehkou váhu
...
- Copilot je okamžitě identifikoval a opravil
...
- Vidět živou aplikaci na internetu bylo skvělé
...
### ✅ Co se mi líbilo
- Interaktivita kvízu byla skvělá, opravdu mě bavilo, jak zábavným způsobem se dá něco naučit.
- Bavilo mě, že jsme si mohli sami vytvořit aplikaci kvízu a vidět výsledek hned v prohlížeči.


### ❌ Co mi nechybělo / Co bych přidal/a
- Copilot začal vysvětlovat kód, což bylo pro mě až moc konkrétní (možná by bylo lepší zaměřit se víc na principy VibeCodingu než na detaily kódu, záleží na preferenci lektorů).
- Ocenil jsem možnost kreativně rozšiřovat kvíz podle vlastních nápadů, což bych klidně ještě víc podpořil.


### ⚠️ Problémy které jsem měl/a
- Copilot někdy navrhuje zbytečné změny, na to ať si děti dají pozor – je důležité, aby studenti i lektoři určovali směr práce a nenechali se zbytečně rozptylovat návrhy AI.
- Během lekce jsem nenarazil na žádné zásadní technické problémy.


### 💡 Co bylo srozumitelné / lehké
- Práce s Claude Opus 4.6 byla zajímavá zkušenost – působí profesionálněji, ale je méně "hravý" než předchozí Copilot.
- Vše bylo srozumitelné, neměl jsem žádné nejasnosti.


### 📝 Poznámky
Pokud by bylo potřeba ještě něco doplnit, rád odpovím na další otázky.
...
### ✅ Co se mi líbilo
- Copilot pracoval přes vite build, což umožnilo rychlé nasazení a testování leaderboardu.
- Byla zde kontinuita s minulým kvízem, což mi pomohlo lépe navázat na předchozí práci.
- Nakonec mě opět bavilo vylepšovat kvíz a zkoušet nové možnosti.

### ❌ Co mi nechybělo / Co bych přidal/a
- Copilot udělal vše najednou, takže v hodině zbylo dost času – možná by bylo fajn mít připravené bonusové aktivity pro rychlejší studenty.
- Navrhl bych společné sdílení obrazovek nebo online prezentaci prací, aby studenti mohli ukázat své výsledky a měli větší motivaci se zlepšovat.

### ⚠️ Problémy které jsem měl/a
- Při vytváření leaderboardu Copilotovi chvíli trvalo, než vše správně nastavil.
- Copilot se mě často ptal na potvrzení příkazu (allow), což trochu zpomalovalo práci.

### 💡 Co bylo srozumitelné / lehké
- Vše bylo srozumitelné, práce s leaderboardem navazovala na předchozí zkušenosti z kvízu.
...
- Tato hodina nezabere moc času

### ⚠️ Problémy které jsem měl/a
- Žádné zásadní problémy – vše fungovalo hladce
- Vercel deployment proběhl bez komplikací 
...
### 📝 Poznámky
- Hodina 9 + 10 tvoří logický celek – backend (Render) + frontend (Vercel) = kompletní aplikace (možná by se mohly spojit)
...
- Víc aktivního zapojení studenta
- Výzvy/úkoly navíc pro rychlejší studenty (bonus tasky)

### Co bych odstranil
- Některé hodiny by se daly sloučit (7+8, nebo 9+10) pro efektivnější využití času
